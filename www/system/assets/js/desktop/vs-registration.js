...
function initPage(){
  if (this.GetElqCustomerGUID) {
    document.forms["vs-registration"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();     
  }
}
...
$(document).ready(function() {
  ...
  if (!(typeof campaignCodeEncoded === "undefined") && (campaignCodeEncoded.length > 0)) {
    if (!(typeof stateEncoded === "undefined") && (stateEncoded.length > 0)) {
      $.ajax({ url: "http://www.hmheducation.com/utils/nationalCodeAndStateToCampaignCode.php", 

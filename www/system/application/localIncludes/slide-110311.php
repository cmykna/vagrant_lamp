...
/*
 ***************************************************************************
 *	@method: slideButto($str, $href, $class)
 *
 *	@var $str
 *	@param string $str
 ...
 *	@var $class
 *	@param string $class
 *	@var string params: 'slide button', 'slide-button-alt'
 *	@var default param: 'slide button'
 *
 *	NOT REQUIRED
 *	ORDER NUMBER 5
*/
	$slide->slideButton("Learn More 1", "#", "button");
	$slide->slideButton("Learn More 2", "#", "button-alt");
	$slide->slideButton("Learn More 3", "#", "button");
	$slide->slideButton("Learn More 4", "#", "button-alt");
/*
 ***************************************************************************

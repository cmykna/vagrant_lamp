...
<?php echo $form_presets['prefix']; ?>
	...
	<form id="<?php echo $form_presets['form_id']; ?>" name="<?php echo $form_presets['form_id']; ?>" class="contact-form" action="<?php echo $form_presets['action']; ?>" method="post">
		<fieldset>
			<div id="olWrapper">
				<input type="hidden" name="elqFormName" value="<?php echo $fp['elq_name']; ?>">
				<?php if ( 'Brain_Honey_form' != $form_presets['form_id'] ): ?>
			...
			<?php endif ?>
				...
				<?php if ( 'Brain_Honey_form' === $form_presets['form_id'] ): ?>
					<li class="radio">
						<h3>Level of Interest <span class="req">required</span></h3>
						<p>
							<label for="C_Partner_Type1">
								<input type="hidden" name="partner_type_contact" value="sales_support@hmhpub.com">
								<input type="radio" name="partner_type" id="C_Partner_Type1" class="required" value="I'm an educator interested in learning more about BrainHoney for my instructional institution.">I'm an educator interested in learning more about BrainHoney for my instructional institution.
							</label>
						</p>
						<p>
							<label for="C_Partner_Type2">
								<input type="hidden" name="partner_type_contact" value="brainhoney@hmhpub.com">
								<input type="radio" name="partner_type" id="C_Partner_Type2" value="I'm a prospective partner interested in exploring new BrainHoney partnership opportunities.">I'm a prospective partner interested in exploring new BrainHoney partnership opportunities.
							</label>
						</p>
						<p>
							<label for="C_Partner_Type3">
								<input type="hidden" name="partner_type_contact" value="brainhoney@hmhpub.com">
								<input type="radio" name="partner_type" id="C_Partner_Type3" value="I'm an existing partner interested in speaking with a BrainHoney Partners team member.">I'm an existing partner interested in speaking with a BrainHoney Partners team member.
							</label>
						</p>
					</li>
				<?php endif; ?>

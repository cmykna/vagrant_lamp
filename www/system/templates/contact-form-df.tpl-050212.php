...
if (isset($_POST['submit'])) {
	if (trim($_POST['C_FirstName']) === '') {
		$errors = true;
	} else {
		$C_FirstName = trim($_POST['C_FirstName']);
	}
}
?>
<script>
...
<div class="buffer">
	...
	<form id="Contact_us" name="Contact_us" class="contact-form" action="http://now.eloqua.com/e/f2.aspx" method="post">
		<fieldset>
			<input type="hidden" name="elqFormName" value="Contact_us">
			...
			<div class="dynamicFormWrapper">
				<ol>
					...
					<li id="submit" class="submit-button"><button type="submit" class="button disabled" name="contact" alt="Contact Us" title="Contact Us" disabled>Contact Us</button></li>

...
<?php
/**
* This is a temporary duplicate of mega-menu.php created for the /forms folder.
* Global mega menu isn't live yet and form-header.tpl.php includes it, so this
* file was created to include instead, just to make sure we don't break anything
* else by pushing mega-menu.tpl.php live before it's ready. CMC 08/13/12
*/
/*
 ***************************************************************************
						...
						<li class="nav-secondary-element">
							...
							<ul class="nav-tertiary">
								<li class="nav-tertiary-element" id="products_advanced-and-electives_disciplines">
									<ul class="nav-quaternary">
										<li class="nav-quaternary-element-title">
											<h3><a href="http://holtmcdougal.hmhco.com/hm/advanced.htm">Disciplines</a></h3>
										</li>
										<li class="nav-quaternary-element">
											<a href="http://holtmcdougal.hmhco.com/hm/series.htm?level2Code=MSIB10027&amp;level3Code=5_AL">Language Arts</a>
										</li>
										<li class="nav-quaternary-element">
											<a href="http://holtmcdougal.hmhco.com/hm/series.htm?level2Code=MSIB10027&amp;level3Code=5_AM">Math</a>
										</li>
										<li class="nav-quaternary-element">
											<a href="http://holtmcdougal.hmhco.com/hm/series.htm?level2Code=MSIB10027&amp;level3Code=5_SC">Science</a>
										</li>
										<li class="nav-quaternary-element">
											<a href="http://holtmcdougal.hmhco.com/hm/series.htm?level2Code=MSIB10027&amp;level3Code=5_AS">Social Studies</a>
										</li>
										<li class="nav-quaternary-element">
											<a href="http://holtmcdougal.hmhco.com/hm/series.htm?level2Code=MSIB10027&amp;level3Code=5_AW">World Languages</a>
										</li>
									</ul>
								</li>
							</ul>
						...
						<li class="nav-secondary-element">
							...
							<ul class="nav-tertiary">
								<li class="nav-tertiary-element" id="services_leadership-and-learning-center">
									<ul class="nav-quaternary">
										<li class="nav-quaternary-element-wide">
											<a href="http://www.leadandlearn.com/strategic-advisory-services">Strategic Advisory Services</a>
										</li>
										<li class="nav-quaternary-element-wide">
											<a href="http://www.leadandlearn.com/comprehensive-solutions-schools-and-districts">Comprehensive Solutions for District and School Leaders</a>
										</li>
										<li class="nav-quaternary-element-wide">
											<a href="http://www.leadandlearn.com/teacher-teacher-series">Teacher-to-Teacher Series</a>
										</li>
										<li class="nav-quaternary-element-wide">
											<a href="http://www.leadandlearn.com/school-improvement-and-transformation-services">School Improvement and Transformation Services</a>
										</li>
									</ul>
								</li>
							</ul>

...
*/
	public function button($class = NULL, $href = NULL, $str = NULL, $alignment = NULL, $external = NULL) {
		...
		if($this->buttonClass == "app-store") {
			$this->buttonStr = (string) "<img src=\"".__S_GLOB_ASSETS__."/global/images/appStore2.gif\" alt=\"App Store\">";
		}
...
/*
 ***************************************************************************
 *	@method: image($file, $alignment, $type, $alt, $title, $href, $width, $height, $class)
 *
 *	@var $file
 *	@param string $file
...
*/
	public function image($file = NULL, $alignment = NULL, $type = NULL, $alt = NULL, $title = NULL, $href = NULL, $width = NULL, $height = NULL, $class = NULL) {
		...
		$this->classImg = ($class != NULL) ? (string) $class : NULL;
		$this->image = ($this->href != NULL) ?
			(string) sprintf("<img class=\"%s%s%s %s\" rel=\"%s|%d|%d\" src=\"%s\" alt=\"%s\" title=\"%s\">", $this->sourceType, $this->alignment, $this->type, $this->classImg, $this->href, $this->width, $this->height, $this->imgFile, $this->alt, $this->title)
			:
			(string) sprintf("<img class=\"%s%s%s %s\" src=\"%s\" alt=\"%s\" title=\"%s\">", $this->sourceType, $this->alignment, $this->type, $this->classImg, $this->imgFile, $this->alt, $this->title);
		return $this->image;
	}
/*
 ***************************************************************************

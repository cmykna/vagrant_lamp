 ...
 *	NOT REQUIRED
*/
	public function bucketLink($str = NULL, $href = NULL, $class = NULL, $external = NULL) {
		$this->bucketLinkStr = ($str != NULL) ? (string) $str : NULL;
		$this->bucketLinkHref = ($href != NULL) ? (string) stripHTTP($href) : NULL;
		...
		$this->bucketLink[] = (string) sprintf("<a%s%shref=\"%s\">%s</a>", $this->rel, $this->bucketLinkClass, $this->bucketLinkHref, $this->bucketLinkStr);
...
*/
	public function image($file = NULL, $alt = NULL, $class = NULL) {
		...
		$this->image[] = (string) sprintf("<img%s src=\"%s\" alt=\"%s\" />", $this->imageClass, $this->imageFile, $this->imageAlt);
		return $this->image;
	}

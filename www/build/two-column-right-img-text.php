 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Right Image and Text");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two Column: <a href="#">Right Image and Text</a></h1>
	<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
	<?php print $element->image(__S_GLOB_IMAGES__."/build/small-image-300x300.gif", "right", "lb", "Small Image 300 x 300 max"); ?>

 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Right Image Team and Text");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two Column: <a href="#">Right Image Team and Text</a></h1>
	<div id="hcard USE FIRST NAME AND LAST NAME OF PERSON HERE" class="vcard">
		...
		<div class="team-rep-right">
			<?php print $element->image(__S_GLOB_IMAGES__."/build/small-image-180x180.gif", "right", "rep", "Small Image 180 x 180 max"); ?>

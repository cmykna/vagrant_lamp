 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Tabs and Text");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two Column: <a href="#">Tabs and Text</a></h1>
...
pellentesque <em><em><em>bold italic text</em></em></em> here parturient?</p>
	...
	<div class="tabCont">
		<div id="tab01">
			<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
			<?php print $element->image(__S_GLOB_IMAGES__."/build/large-image-640x300.gif", "center", NULL, "Large Image 640 x 300 max"); ?>

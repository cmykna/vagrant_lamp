 ...
 ***************************************************************************
*/
	$page->pageTitle("One Column: Left Image and Text");
...
<div class="buffer">
	<h1>One Column: <a href="#">Left Image and Text</a></h1>
	<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
	<?php print $element->image(__S_GLOB_IMAGES__."/build/small-image-300x300.gif", "left", "s2l", "Small Image 300 x 300 max"); ?>

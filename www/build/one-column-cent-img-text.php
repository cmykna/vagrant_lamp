 ...
 ***************************************************************************
*/
	$page->pageTitle("One Column: Centered Image and Text");
...
<div class="buffer">
	<h1>One Column: <a href="#">Centered Image and Text</a></h1>
	<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
	<?php print $element->image(__S_GLOB_IMAGES__."/build/large-image-912x300.gif", "center", "lb", "Large Image 912 x 300 max"); ?>

 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Left Image and Text");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two Column: <a href="#">Left Image and Text</a></h1>
	<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
	<?php print $element->image(__S_GLOB_IMAGES__."/build/small-image-300x300.gif", "left", "lb", "Small Image 300 x 300 max"); ?>
...
<hr />
<div class="buffer">
	<?php print $element->image(__S_GLOB_IMAGES__."/build/small-image-300x300-image-to-video-lb.gif", "left", "lb", "Small Image 300 x 300 max", NULL, "//hmheducation.com/tx/sci5/video/tx-sci5-video.php", 640, 360); ?>
    <p>Below is a text to video link.</p>
	<?php print $element->iconButton("video", __S_GLOB_ASSETS__."/external/avancemos/avancemos-como-es-tu-familia-video.php", "Lightbox Video", NULL, "fancy-vidLink") ?>
</div>
<hr />
<?php
/*

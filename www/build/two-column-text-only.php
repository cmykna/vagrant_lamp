 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Text Only");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two Column: <a href="#">Text Only</a></h1>
...
pellentesque <em><em><em>bold italic text</em></em></em> here parturient?</p>
	...
	<?php print $element->iconButton("download", "#", "Opens External DL", "1.36mb", 1); ?>
	<?php print $element->iconButton("video", "#", "Watch a video", NULL, "fancy-vidLink"); ?>
	<?php print $element->iconButton("more-info", "#", "Lightbox Link", NULL, "fancy-vidLink"); ?>
	...
	<?php print $element->button("button-alt", "#", "Button Alt"); ?>

 ...
 ***************************************************************************
*/
	$page->pageTitle("Two Column: Centered Large Image and Text");
/*
 ***************************************************************************
 *	DO NOT EDIT
...
<div class="buffer">
	<h1>Two <em>Column</em>: <a href="#">Centered Large Image and Text</a></h1>
	<h2>H2 Secondary Feature <a href="#">Headline</a></h2>
	<?php print $element->image(__S_GLOB_IMAGES__."/build/large-image-684x300.gif", "center", "s2l", "Large Image 684 x 300 max"); ?>
...
pellentesque <em><em><em>bold italic text</em></em></em> here parturient? <a href="#">Test <em>Program Name</em></a></p>
	<blockquote>
	...
	<ol>
		<li>Bullet One<sup>&reg;</sup><br />
			the second line should hang under the first line</li>
		<li><a href="#">Number <em>Two</em></a></li>
		<li>Number Three</li>
	</ol>
	<p>This is body copy platea magna, in diam, tortor</p>
	...
	<?php print $element->button("button", "#", "<em>Button</em>", "right-align"); ?>
	<?php print $element->button("button", "#", "Button"); ?>
	<?php print $element->button("button-alt", "#", "Button <em>Alt</em>", "right-align"); ?>
	<?php print $element->button("button-alt", "#", "Button"); ?>
	<?php print $element->button("button-opt", "#", "Button <em>Opt</em>", "right-align"); ?>
